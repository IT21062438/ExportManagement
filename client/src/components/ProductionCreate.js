...
export default class ProductionCreate extends Component {
  ...
  btnDemo = (e) => {
    ...
    this.setState({
      ...
      category: "TEA",
      description:
        "Coriander seeds come from the small fruits that appear after the cilantro herb flowers. They can be harvested when green, or they can be left to brown and dry out on the plant. Pounded fresh green coriander has a bright flavor that’s ideal for dressing a salad. The dried, tan pods most often found in spice cabinets have a citrusy, floral taste that is often paired with cumin in Indian cuisine, Moroccan tagines, homemade burgers, or poaching liquor for fish.",
    });
  };
  //Clear button
  btnClear = (e) => {
            ...
            >
              <div className="col-md-8 mt-4 mx-auto">
                <center>
                  ...
                  >
                    <b>ADD NEW PRODUCTION SLOT CARD</b>
                  </h1>
                </center>
                  ...
                  <div class="row">
                    <div class="col">
                      ...
                      <input
                        ...
                        class="form-control"
                        name="slotManager"
                        placeholder="Enter Slot Manager Name"
