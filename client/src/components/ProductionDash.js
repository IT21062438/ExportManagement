...
export default class ProductionDash extends Component {
  ...
  onDelete = (id) => {
    axios
      .delete(`http://localhost:8000/production/deleteproduction/${id}`)
      .then((res) => {
  ...
  filterData(production, searchKey) {
    const result = production.filter(
      (production) =>
      ...
      <div id="wrapper" className="toggled">
        <div style={{ backgroundColor: "#e3dac9" }} id="page-content-wrapper">
          <div className="container-fluid">
            ...
            {/* Filter Category */}
            <div
              className="p-3 mb-2 text-light rounded-3"
                  ...
                  {this.state.production.map((production, index) => (
                    <tr>
                      ...
                      <td>
                        <b>
                          <a
                            href={`/propost/${production._id}`}
                            style={{ textDecoration: "none", color: "#0E3662" }}
                          >
